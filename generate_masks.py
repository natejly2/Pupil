...
# loop through images in frames_folder
    ...
    for i in range(num_frames):
        ...
        # flip across y axis
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(eye_gray, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        # cv2.imwrite(f"frames/{i}.png", frame)
        frame_idx += 1
        ...
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(brightup, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        # cv2.imwrite(f"frames/{i}.png", frame)
        frame_idx += 1
        ...
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(brightdown, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        frame_idx += 1
        ...
        cv2.imwrite(f"best_masks/{frame_idx}.png", export)
        frame_idx += 1
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(sharp, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        frame_idx += 1
        ...
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(sharpdown, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        frame_idx += 1
        ...
        cv2.imwrite(f"images/{frame_idx}.png", eye_gray2)
        cv2.imwrite(f"best_masks/{frame_idx}.png", export)
        frame_idx += 1

        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(eye_gray2, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        frame_idx += 1
        ...
        cv2.imwrite(f"best_masks/{frame_idx}.png", export)
        frame_idx += 1
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(blur, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        frame_idx += 1
        # gamma augment
        ...
        cv2.imwrite(f"best_masks/{frame_idx}.png", export)
        frame_idx += 1
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(gamma_corrected, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(export, 1))
        frame_idx += 1
        ...
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(rotated_gray, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(rotated_mask, 1))
        frame_idx += 1
        ...
        cv2.imwrite(f"images/{frame_idx}.png", cv2.flip(stretched_gray, 1))
        cv2.imwrite(f"best_masks/{frame_idx}.png", cv2.flip(stretched_mask, 1))
        frame_idx += 1
